// Comes From https://github.com/ColinLeung-NiloCat/UnityURPUnlitScreenSpaceDecalShader/blob/master/URP_NiloCatExtension_ScreenSpaceDecal_Unlit.shader
Shader "URP_Practise/ScreenSpaceDecal"
{
    Properties
    {
        [Header(Basic)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata input)
            {
                ...
                //store the division value to varying o.viewRayOS.w，because the z division in VS is negative, so we use "-z"
                //=========================================================
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                //return half4(i.viewRayOS.w - sceneDepthVS, 0, 0, 1);
                //return half4(1, 1, 1, length(i.viewRayOS.xyz));
                ...
                //return half4(decalSpaceScenePos, 1);
                #if _SupportOrthographicCamera
                }
                #endif
